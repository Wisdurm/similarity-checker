...
Files are sorted based on "tags". Tags maybe anything you want, they just have
to be the same for every file you want to compare. Tag must be in the url:  
https://localhost:5000?task=coolrepos
